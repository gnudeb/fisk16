...
class Fisk16InstructionsTests(unittest.TestCase):
    ...
    def test_mov_r16_r16(self):
        self.cpu.ram.write(0, 0x0001, 2)    # mov r1, r0
    ...
    def test_r16_ind(self):
        self.cpu.ram.write(0, 0x0101, 2)    # mov r1, [r0]
    ...
    def test_ind_r16(self):
        self.cpu.ram.write(0, 0x0201, 2)    # mov [r1], r0
    ...
    def test_r8_r8(self):
        self.cpu.ram.write(0, 0x0301, 2)    # mov r0h, r0l
    ...
    def test_r8_ind(self):
        self.cpu.ram.write(0, 0x0410, 2)      # mov r0l, [r1]
        self.cpu.register_ram.write(2, 8, 2)  # r1 = 8
    ...
    def test_ind_r8(self):
        self.cpu.ram.write(0, 0x0501, 2)      # mov [r1], r0l
        self.cpu.register_ram.write(2, 8, 2)  # r1 = 8
